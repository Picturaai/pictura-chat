export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote Pictura server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'Pictura AI Cloud',
