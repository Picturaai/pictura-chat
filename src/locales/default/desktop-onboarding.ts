export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using Pictura AI Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Pictura. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve Pictura',
  ...
  'screen5.actions.signInCloud': 'Sign in to Pictura AI Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Pictura AI Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Pictura AI Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Pictura server instance',
