export default {
  ...
  'models.providerInfo.apiTooltip': 'Pictura supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Pictura Official Service',
  ...
  'skills.details.sidebar.agent.useOnLobeAI': 'Use on Pictura AI',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by Pictura automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the Pictura marketplace with one click.',
