...
export const FEEDBACK = 'mailto:support@picturaai.sbs';
export const PRIVACY_URL = urlJoin(OFFICIAL_SITE, '/privacy');
export const TERMS_URL = urlJoin(OFFICIAL_SITE, '/terms');

export const PLUGINS_INDEX_URL = 'https://chat-plugins.lobehub.com';

export const MORE_MODEL_PROVIDER_REQUEST_URL = 'mailto:support@picturaai.sbs';

export const MORE_FILE_PREVIEW_REQUEST_URL = 'mailto:support@picturaai.sbs';
